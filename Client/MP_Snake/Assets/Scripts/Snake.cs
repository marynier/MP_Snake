...
public class Snake : MonoBehaviour
{
    ...
    //private Vector3 _targetDirecton = Vector3.zero;
    private Tail _tail;
    ...
    private void Rotate()
    {
        //Quaternion targetRotation = Quaternion.LookRotation(_targetDirecton);
    ...
    {
        //_targetDirecton = cursorPosition - _head.position;
